...
public class JSVGScrollPane extends JPanel
{
     ...
     */
    public JSVGScrollPane(JSVGCanvas svgCanvas) {
        super();
        ...
        svgCanvas.addSVGDocumentLoaderListener(createLoadListener());

        // canvas listeners
        ScrollListener xlistener = createScrollListener();
        addComponentListener(xlistener);
        svgCanvas.addGVTTreeRendererListener(xlistener);
        svgCanvas.addJGVTComponentListener  (xlistener);
        svgCanvas.addGVTTreeBuilderListener (xlistener);
        svgCanvas.addUpdateManagerListener  (xlistener);
    }// JSVGScrollPane()
